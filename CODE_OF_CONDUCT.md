...
pull requests, discussions, Discord, etc.) and also applies when an
individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers via a GitHub Security Advisory-style private
report on the `Aeon-framework/aeon` repository, or by opening an issue titled
only "Code of Conduct report — please contact privately" with no further
public detail. All complaints will be reviewed and investigated promptly and
fairly.
